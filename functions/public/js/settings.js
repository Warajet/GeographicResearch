...
// settings.js file used to handle all the operations required in settings.html 

// Declare all the variables required for setting the parameters in the system
// Parameters include, NO3, pH, Ca, EC, K
...
// Helper function used to get the list of available parameters in the system
...
// Helper function used to display the set of paramaters together with its threshold value(max and min)
...
// Function used to create buttons for modifying information about settings
...
// Function used to allow user to edit the cell in the parameter table
...
// Function used to save the column changes specified by user
...
// Helper function used to reload/update the table after changes are applied
function reloadData() {
